from PySide6.QtWidgets import (QHBoxLayout, QHeaderView, QSizePolicy,
                               QTableView, QWidget)
from PySide6.QtCore import QDateTime, Qt, Slot, QPersistentModelIndex
...
from ichartview import IChartView
