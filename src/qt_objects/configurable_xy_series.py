...
import PySide6
from PySide6.QtCharts import QXYSeries, QScatterSeries
from PySide6.QtCore import Slot


class ConfigurableXYSeries(QXYSeries):
    """
    A QXYSeries which keeps a second scatter series to keep track of point ids.
    ...
    def update_points_configuration(self):
        ...
        self.setPointsConfiguration(conf)
